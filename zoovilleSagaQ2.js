...
const herbivore = {
    feedHerbivoreFood: function () {
        ...
        console.log(`You have just fed the herbivore ${this.species} ${this.name} and it now has fullness of ${this.hungerMeter}`)
    }
}
...
const carnivore = {
    feedCarnivoreFood: function () {
        ...
        console.log(`You have just fed the carnivore ${this.species} ${this.name} and it now has fullness of ${this.hungerMeter}`)
    }
}
